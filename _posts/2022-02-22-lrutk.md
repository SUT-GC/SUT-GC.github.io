...
```java
@Override
@TokenBucketAop(region = "goods_activity_for_order", keyArgName = "useActivityDTO", keySpEL = "#root.goodsId")
...
public class CaffeineTokenBucketContainer implements TokenBucketContainer {
    ...
    private RemovalListener<String, AtomicInteger> buildRemovalListener(String region) {
        return (key, value, cause) -> {
            ...
            tags.put("platform_service", "libra-detail");
...
public class TokenBucketAspect {
    ...
    @Around("@annotation(com.yiran.service.libra.common.tokenbucket.aop.TokenBucketAop)")
